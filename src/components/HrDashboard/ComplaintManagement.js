...
export default function ComplaintManagement() {
  ...
  const [dialogOpen, setDialogOpen] = useState(false); // edit/update dialog
  ...
  return (
    <Box sx={{ p: 3, background: COLORS.bg, minHeight: "70vh" }}>
      ...
      <Dialog open={dialogOpen} onClose={closeDialog} fullWidth maxWidth="md">
        <DialogTitle>
          {editing ? "Update Complaint" : "New Complaint"}
        </DialogTitle>
            ...
            <Grid item xs={12} md={8}>
              ...
              <Box sx={{ mt: 2 }}>
                <TextField
                  ...
                  placeholder="Add internal remark or response"
                />
              </Box>
            </Grid>
            <Grid item xs={12} md={4}>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={saveUpdate} disabled={!editing}>
            Save
          </Button>
        </DialogActions>
      </Dialog>
