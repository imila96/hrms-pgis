...
import {
  Box, Drawer, Toolbar, Typography, AppBar, List, ListItem, ListItemText,
  IconButton, Menu, MenuItem, Avatar, Tooltip, Badge, useTheme
} from "@mui/material";
...
export default function DirectorDashboard() {
  ...
  const handleProfile = () => { handleMenuClose(); navigate("/director/profile"); };
    ...
    <Box sx={{ display: "flex" }}>
      <AppBar position="fixed" sx={{ zIndex: (t) => t.zIndex.drawer + 1 }}>
        <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
          <Typography variant="h6" noWrap>Director Dashboard</Typography>
